  ...
  return (
    ...
    >
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">View and assign performance ratings.</p>
      </div>
      ...
      <div className="p-12 text-center border rounded-xl border-dashed">
        ...
        <p className="text-sm text-muted-foreground">The full performance ratings matrix will go here.</p>
      </div>
    </motion.div>
  );
}
